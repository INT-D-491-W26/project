...
- **Modelling**: Compare various ensemble machine learning algorithms (Random Forest, XGBoost, AdaBoost) to identify the best-performing model for fraud detection.
- **Cost Evaluation**: Use F1-Score and recall to assess models and a cost formula to evaluate trade-offs between fraud detection accuracy and false positives to ensure the system balances risk and customer experience effectively.
